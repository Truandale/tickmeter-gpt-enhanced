    ...
    public partial class AdvancedSettingsForm : Form
    {
        ...
        private void btnReset_Click(object sender, EventArgs e)
        {
            var result = MessageBox.Show(
                ...
                "• Оптимизированные буферы PCAP (8MB kernel, 4KB min copy)\n" +
                "• Расширенный оверлей (процесс, время сессии, внешний IP)\n\n" +
            ...
            if (result == DialogResult.Yes)
            {
                ...
                MessageBox.Show(
                    ...
                    "✓ Производительность: PCAP буферы (8MB kernel, 4KB min copy)\n" +
                    "✓ Оверлей: расширенная информация (процесс, время, IP)\n\n" +
        ...
        private void SetOptimalSettings()
        {
            ...
            MessageBox.Show("Восстановлены ваши проверенные оптимальные настройки! ✅\n\n" +
                           ...
                           "• Цветовая схема: красный/жёлтый/зелёный (+ синий для лейблов)\n\n" +
                           "⚙️ СИСТЕМА:\n" +
                           ...
                           "🔧 ПРОИЗВОДИТЕЛЬНОСТЬ:\n" +
                           "• Все сглаживания включены | Гибридный PCAP+Windows Stats\n" +
                           "• Virtual mode: 1000 строк макс. в Live View\n" +
                           "• PCAP оптимизация: 8MB kernel buffer, 4KB min copy\n" +
                           "• Anti-reentrancy + RTSS throttling включены\n\n" +
                           "🛡️ VPN & БЕЗОПАСНОСТЬ:\n" +
                           ...
                           "• Порог: 150ms | Чувствительность: очень низкая\n" +
                           "• EMA Alpha: 0.1 | EW-Sigma: 0.05\n" +  // БАГ #76: Исправлены значения с 0.050→0.1, 0.020→0.05
                           "• Множитель: 2 | Гистерезис: 0.8\n" +    // БАГ #76: Исправлены значения с 3.0→2, 0.70→0.8
                           "• Период тишины: 2000ms | Выборка: 30\n" +
                           "• Мин. энергия: 1 | Мин. длительность: 50ms\n" +  // БАГ #76: Исправлено значение с 2.0→1
        ...
        private void LoadNetworkQualitySettings()
        {
            try
            {
                ...
                chkProfileStabilityTolerance.Checked = App.settingsManager.GetOption("quality_profile_stability_tolerance", "True", "ADVANCED") == "True";
        ...
        private void SaveNetworkQualitySettings()
        {
            try
            {
                ...
                App.settingsManager.SetOption("quality_profile_stability_tolerance", chkProfileStabilityTolerance.Checked.ToString(), "ADVANCED");
        ...
        private void CmbColorZoneProfile_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show($"Error updating color zone profile: {ex.Message}", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
